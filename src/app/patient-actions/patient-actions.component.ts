...
dropPatientSlots() {
  this.http.get(`https://phase-2-backend-git-youssuf-el-tahan-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/patient_slots/`).subscribe(
    (response: any) => {
  ...
  getDoctorSlots(docId: string) {
    this.http.get(`https://phase-2-backend-git-youssuf-el-tahan-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/show_slots/${docId}`).subscribe(
      (res: any) => {
  ...
  getDoctorName() {
    this.http.get('https://phase-2-backend-git-youssuf-el-tahan-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/select_doctor/').subscribe(
      (response: any) => {
  ...
  chooseSlot() {
    ...
    this.http.post('https://phase-2-backend-git-youssuf-el-tahan-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/choose_slot/', {slot_id: slotId })
      .subscribe(
        (response: any) => {
          console.log(response);
          this.dropPatientSlots();
  ...
  updateAppointment() {
    ...
    this.http.put('https://phase-2-backend-git-youssuf-el-tahan-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/update_appointment/', {
  ...
  cancelAppointment(){
    ...
    this.http.delete<any>(`https://phase-2-backend-git-youssuf-el-tahan-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/cancel_appointment/`, {
