...
ENV API_URL=https://backendphase-3-hamota-git-youssuf-el-tahan-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/
USER 1009800000
COPY . .
RUN chown -R 1009800000:0 /app/src/environments/environment.ts
